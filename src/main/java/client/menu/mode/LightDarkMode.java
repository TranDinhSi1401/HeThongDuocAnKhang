...
public class LightDarkMode extends JPanel {
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("hethongnhathuocduocankhang/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("hethongnhathuocduocankhang/menu/mode/light.svg"));
        }
    }
