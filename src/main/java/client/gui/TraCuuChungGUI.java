...
//        }
    ...
    private void btnXemTatCaSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaSanPhamActionPerformed
        // TODO add your handling code here:
        Response resSP = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_SAN_PHAM, null));
        if (resSP.isSuccess() && resSP.getData() != null)
            themSPVaoBang((java.util.List<SanPhamDTO>) resSP.getData());
    ...
    private void btnXemTatCaHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaHoaDonActionPerformed
        // TODO add your handling code here:
        Response resHD = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_HOA_DON, null));
        if (resHD.isSuccess() && resHD.getData() != null)
            themHoaDonVaoBang((java.util.List<HoaDonDTO>) resHD.getData());
    ...
    private void btnXemTatCaNhaCungCapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaNhaCungCapActionPerformed
        // TODO add your handling code here:
        Response resNCC = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_NHA_CUNG_CAP, null));
        if (resNCC.isSuccess() && resNCC.getData() != null)
            themNCCVaoBang((java.util.List<NhaCungCapDTO>) resNCC.getData());
    ...
    private void btnXemTatCaKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaKhachHangActionPerformed
        // TODO add your handling code here:
        Response resKH = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_KHACH_HANG, null));
        if (resKH.isSuccess() && resKH.getData() != null)
            themKhachHangVaoBang((java.util.List<KhachHangDTO>) resKH.getData());
    ...
    private void btnXemTatCaNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaNhanVienActionPerformed
        // TODO add your handling code here:
        Response resNV = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_NHAN_VIEN, null));
        if (resNV.isSuccess() && resNV.getData() != null)
            themNhanVienVaoBang((java.util.List<NhanVienDTO>) resNV.getData());
    ...
    private void btnXemTatCaPhieuNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaPhieuNhapActionPerformed
        // TODO add your handling code here:
        Response resPN = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_PHIEU_NHAP, null));
        if (resPN.isSuccess() && resPN.getData() != null)
            themPhieuNhapVaoBang((java.util.List<PhieuNhapDTO>) resPN.getData());
    ...
    private void btnXemTatCaPhieuTraHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaPhieuTraHangActionPerformed
        // TODO add your handling code here:
        Response resPTH = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_PHIEU_TRA_HANG, null));
        if (resPTH.isSuccess() && resPTH.getData() != null)
            themPhieuTraHangVaoBang((java.util.List<PhieuTraHangDTO>) resPTH.getData());
    ...
    private void btnXemTatCaKhuyenMaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemTatCaKhuyenMaiActionPerformed
        // TODO add your handling code here:
        Response resKM = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_KHUYEN_MAI, null));
        if (resKM.isSuccess() && resKM.getData() != null)
            themKhuyenMaiVaoBang((java.util.List<KhuyenMaiDTO>) resKM.getData());
...
// Tra cứu sản phẩm
    ...
    private void timSanPhamTheoThuocTinh(String thuocTinh, String key) {
        ...
        Response resLocSP = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_SAN_PHAM, null));
        if (resLocSP.isSuccess() && resLocSP.getData() != null)
            themSPVaoBang((java.util.List<SanPhamDTO>) resLocSP.getData());
    }
    ...
    private void locSanPhamTheoTieuChi(String sqlSub ,boolean thuocKhongKeDon, boolean thuocKeDon, boolean tpChucNang) {
        ...
        //Đưa danh sách trả về vào bảng
        Response resTimSP = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_SAN_PHAM, null));
        if (resTimSP.isSuccess() && resTimSP.getData() != null)
            themSPVaoBang((java.util.List<SanPhamDTO>) resTimSP.getData());
...
//Nhà cung cấp
    ...
    private void timNhaCungCapTheoThuocTinh(String thuocTinh, String key) {
        ...
        //Đưa danh sách trả về vào bảng
        Response resLocNCC = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_NHA_CUNG_CAP, null));
        if (resLocNCC.isSuccess() && resLocNCC.getData() != null)
            themNCCVaoBang((java.util.List<NhaCungCapDTO>) resLocNCC.getData());
    }
...
//            
        ...
        //Đưa danh sách trả về vào bảng
        Response resTimNCC = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_NHA_CUNG_CAP, null));
        if (resTimNCC.isSuccess() && resTimNCC.getData() != null)
            themNCCVaoBang((java.util.List<NhaCungCapDTO>) resTimNCC.getData());
        System.out.println(sql);
    ...
    private void themNCCVaoBang(ArrayList<NhaCungCap> allTableCungCap) {
        ...
        for(NhaCungCap nccTam : allTableCungCap){
            ...
            dtm.addRow(ncc);
            System.out.println("client.gui.TraCuuChungGUI.themNCCVaoBang()");
        }
    }
...
//Khách hàng
    ...
    private void timKhachHangTheoThuocTinh(String thuocTinh, String key) {
        ...
        //Đưa danh sách trả về vào bảng
        Response resLocKH = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_KHACH_HANG, null));
        if (resLocKH.isSuccess() && resLocKH.getData() != null)
            themKhachHangVaoBang((java.util.List<KhachHangDTO>) resLocKH.getData());
        System.out.println(sql);
    }
...
//            
        ...
        //Đưa danh sách trả về vào bảng
        Response resTimKH = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_ALL_KHACH_HANG, null));
        if (resTimKH.isSuccess() && resTimKH.getData() != null)
            themKhachHangVaoBang((java.util.List<KhachHangDTO>) resTimKH.getData());
        System.out.println(sql);
...
//Hóa đơn
    ...
    private void hienThiChiTietHoaDon(MouseEvent e) {
        ...
        if (selectRow != -1) {
            ...
            Response r = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_HOA_DON_BY_MA, maHD));
            if (r.isSuccess() && r.getData() != null) {
                HoaDonDTO hdDaChon = (HoaDonDTO) r.getData();
                ChiTietHoaDonGUI chiTietPanel = new ChiTietHoaDonGUI();
                chiTietPanel.loadData(hdDaChon);
                JDialog dialog = new JDialog();
                dialog.setTitle("Chi tiết hóa đơn: " + maHD);
                dialog.setModal(true);
                dialog.setContentPane(chiTietPanel);
...
//Phiếu trả hàng
    ...
    private void hienThiChiTietPhieuTraHang(MouseEvent e) {
        ...
        if (selectRow != -1) {
            ...
            Response r = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_PTH_BY_MA, maPTH));
            if (r.isSuccess() && r.getData() != null) {
                PhieuTraHangDTO pthDaChon = (PhieuTraHangDTO) r.getData();
                ChiTietPhieuTraHangGUI chiTietPanel = new ChiTietPhieuTraHangGUI();
                chiTietPanel.loadData(pthDaChon);
                JDialog dialog = new JDialog();
                dialog.setTitle("Chi tiết phiếu trả: " + maPTH);
                dialog.setModal(true);
                dialog.setContentPane(chiTietPanel);
                dialog.setPreferredSize(new Dimension(900, 500));
                dialog.pack(); dialog.setLocationRelativeTo(null); dialog.setVisible(true);
