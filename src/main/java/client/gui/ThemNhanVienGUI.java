...
public class ThemNhanVienGUI extends javax.swing.JPanel {
    ...
    private NhanVienDTO nhanVienMoi = null;
    private TaiKhoanDTO taiKhoanMoi = null;
    ...
    public NhanVienDTO getNhanVienMoi() {
        return this.nhanVienMoi;
    }

    public TaiKhoanDTO getTaiKhoanMoi() {
    ...
    public void setTaiKhoanMoi(TaiKhoanDTO taiKhoanMoi) {
    ...
    private void xuLyXacNhan() {
        ...
        try {
            ...
            this.nhanVienMoi = new NhanVienDTO();
            this.taiKhoanMoi = new TaiKhoanDTO();
