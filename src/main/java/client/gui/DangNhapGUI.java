...
public class DangNhapGUI extends javax.swing.JFrame {
    ...
    public DangNhapGUI() {
        ...
        URL url = DangNhapGUI.class.getResource("/images/logo.png");
        if (url != null) {
    ...
    private void initComponents() {
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/logo.png")))); // NOI18N
        ...
        btnCheMatKhau.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/hidePasswordEye.png")))); // NOI18N
    ...
    private void dangNhap() {
        ...
        Request loginRequest = new Request(CommandType.LOGIN, new Object[]{tenDangNhap, matKhau});
        Response loginResponse = SocketClient.getInstance().sendRequest(loginRequest);
    ...
    private void lblQuenMatKhauMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblQuenMatKhauMouseClicked
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            Request request = new Request(CommandType.GET_TAI_KHOAN_BY_MA_NV, userName);
            Response userResponse = SocketClient.getInstance().sendRequest(request);
            ...
            TaiKhoanDTO tk = (TaiKhoanDTO) userResponse.getData();
            if (tk == null) {
                JOptionPane.showMessageDialog(this,
            ...
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                ...
                protected Boolean doInBackground() throws Exception {
                    return PasswordUtil.quenMatKhau(userName, email);
                }
                ...
                protected void done() {
                    ...
                    try {
                        ...
                        if (ok) {
                            ...
                            // Đặt flag để nhắc người dùng khi đăng nhập lại
