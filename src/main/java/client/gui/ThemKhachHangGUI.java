...
public class ThemKhachHangGUI extends javax.swing.JPanel {
    ...
    private KhachHangDTO khachHangMoi = null;

    public ThemKhachHangGUI() {
        initComponents();

        setupButton(jButton1, new java.awt.Color(255, 51, 51)); // Nút Hủy (Đỏ)
        setupButton(jButton2, new java.awt.Color(0, 203, 0));   // Nút Xác nhận (Xanh lá)
    ...
    public KhachHangDTO getKhachHangMoi() {
    ...
    private void xuLyXacNhan() {
        ...
        try {
            ...
            this.khachHangMoi = KhachHangDTO.builder()
                .maKH(maKH)
                .hoTenDem(hoTenDem)
                .ten(ten)
                .sdt(sdt)
