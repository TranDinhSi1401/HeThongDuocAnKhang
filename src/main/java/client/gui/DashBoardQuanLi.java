...
public class DashBoardQuanLi extends javax.swing.JPanel {
    ...
    public DashBoardQuanLi() {
        ...
        Response resNv = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_NHAN_VIEN_BY_MA, GiaoDienChinhGUI.getTkDTO().getMaNV()));
    ...
    private void initBieuDo() {
        ...
        Response resDangLam = SocketClient.getInstance().sendRequest(new Request(CommandType.GET_LSCL_DANG_LAM_BY_MA_NV, GiaoDienChinhGUI.getTkDTO().getMaNV()));
    ...
    private void configureBtnVaoCa() {
        ...
        btnVaoCa.addActionListener(e -> {
            try {
                ...
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Lỗi khi xử lý ca làm!");
            }
        });
    }
