...
public class ThemKhuyenMaiGUI extends javax.swing.JPanel {
    ...
    private KhuyenMaiDTO khuyenMaiMoi = null;
    ...
    public void setCmbLoaiKhuyenMai(String loai) {
        if (loai != null) {
            jComboBox1.setSelectedItem(loai);
        }
    }
    ...
    public KhuyenMaiDTO getKhuyenMaiMoi() {
    ...
    private void xuLyXacNhan() {
        ...
        try {
            ...
            String loaiKM = jComboBox1.getSelectedItem().toString();
            ...
            this.khuyenMaiMoi = KhuyenMaiDTO.builder()
                    .maKhuyenMai(maKM)
                    .moTa(moTa)
                    .phanTram(phanTram)
                    .loaiKhuyenMai(loaiKM)
                    .ngayBatDau(ngayBatDau)
                    .ngayKetThuc(ngayKetThuc)
                    .soLuongToiThieu(slToiThieu)
                    .soLuongToiDa(slToiDa)
                    .build();
